...
In this Module you can also add any custom modules you want to your application. You can look at the [Block Notifier example](/block-notifier) to see how a custom telegram module can be added to the indexer.
