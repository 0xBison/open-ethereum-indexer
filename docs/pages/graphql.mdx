...
> GraphQL support is currently experimental and only works with generic entities (those created through the generic indexing system). Custom entities are not yet supported.
