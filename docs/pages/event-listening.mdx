...
Open Ethereum Indexer provides an easy to use mechanism for monitoring and processing smart contract events. This page explains how to set up event handlers and process blockchain events in your application.
