...
export class InitialSchema1742274226041 implements MigrationInterface {
  name = 'InitialSchema1742274226041';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "public"."event_with_struct_with_dynamic_struct_array_de916601" ("unique_event_id" character varying(64) NOT NULL, "event_origin_address" character varying(66) NOT NULL, "created_date" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "tx_index" numeric(5) NOT NULL, "log_index" numeric(5) NOT NULL, "log_data" character varying NOT NULL, "block_hash" character varying(66) NOT NULL, "block_number" bigint NOT NULL, "block_timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "transaction_hash" character varying(66) NOT NULL, "topics" character varying array NOT NULL, "the_struct_id" integer, CONSTRAINT "REL_6e8a03b3552be699debc5b5ca6" UNIQUE ("the_struct_id"), CONSTRAINT "PK_ca2b6fb84dff8661bd6dfa05b33" PRIMARY KEY ("unique_event_id"))`);
    ...
    await queryRunner.query(`CREATE TABLE "public"."event_with_dynamic_array_e56f559a" ("unique_event_id" character varying(64) NOT NULL, "event_origin_address" character varying(66) NOT NULL, "created_date" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "tx_index" numeric(5) NOT NULL, "log_index" numeric(5) NOT NULL, "log_data" character varying NOT NULL, "block_hash" character varying(66) NOT NULL, "block_number" bigint NOT NULL, "block_timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "transaction_hash" character varying(66) NOT NULL, "topics" character varying array NOT NULL, CONSTRAINT "PK_a9816b7a574837ce8e4e0b6b799" PRIMARY KEY ("unique_event_id"))`);

    await queryRunner.query(`CREATE TABLE "public"."event_with_fixed_array_696b4daf" ("unique_event_id" character varying(64) NOT NULL, "event_origin_address" character varying(66) NOT NULL, "created_date" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "tx_index" numeric(5) NOT NULL, "log_index" numeric(5) NOT NULL, "log_data" character varying NOT NULL, "block_hash" character varying(66) NOT NULL, "block_number" bigint NOT NULL, "block_timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "transaction_hash" character varying(66) NOT NULL, "topics" character varying array NOT NULL, CONSTRAINT "PK_e539ad809acd9d7253aab6cbee3" PRIMARY KEY ("unique_event_id"))`);
    ...
    await queryRunner.query(`CREATE TABLE "public"."event_with_struct_with_fixed_struct_array_68e489fd" ("unique_event_id" character varying(64) NOT NULL, "event_origin_address" character varying(66) NOT NULL, "created_date" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "tx_index" numeric(5) NOT NULL, "log_index" numeric(5) NOT NULL, "log_data" character varying NOT NULL, "block_hash" character varying(66) NOT NULL, "block_number" bigint NOT NULL, "block_timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "transaction_hash" character varying(66) NOT NULL, "topics" character varying array NOT NULL, "the_struct_id" integer, CONSTRAINT "REL_388a248d03c3ecd2584defb624" UNIQUE ("the_struct_id"), CONSTRAINT "PK_1de38652eac53679a662576f19e" PRIMARY KEY ("unique_event_id"))`);
    ...
    await queryRunner.query(`CREATE TABLE "public"."event_with_struct_with_nested_struct_4ec25295" ("unique_event_id" character varying(64) NOT NULL, "event_origin_address" character varying(66) NOT NULL, "created_date" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "tx_index" numeric(5) NOT NULL, "log_index" numeric(5) NOT NULL, "log_data" character varying NOT NULL, "block_hash" character varying(66) NOT NULL, "block_number" bigint NOT NULL, "block_timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "transaction_hash" character varying(66) NOT NULL, "topics" character varying array NOT NULL, "the_struct_id" integer, CONSTRAINT "REL_095c4404deff21bd8fbbe12d61" UNIQUE ("the_struct_id"), CONSTRAINT "PK_856cb7c232501d70c6e86a7fc34" PRIMARY KEY ("unique_event_id"))`);
