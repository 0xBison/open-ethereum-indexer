...
import { InitialSchema1742010663938 } from './someContract/migrations/1742010663938-InitialSchema';
...
describe('Test event indexing of SomeContract - Exhaustive solidity event test suite', () => {
    ...
    try {
      ...
      const indexerConfig: IndexerTestSetupConfig = {
        ...
        databaseConfig: {
          ...
          migrations: [InitialSchema1742010663938],
        },
      };
  ...
  it('should have indexed SimpleEvent correctly', async () => {
    // Emit the event
    ...
    expect(event.addrValue).toBe('0x0000000000000000000000000000000000000123');
  ...
  it('should have indexed EventWithFixedArray correctly', async () => {
    // Emit the event
  ...
  it('should have indexed EventWithDynamicArray correctly', async () => {
    // Emit the event
  ...
  it('should have indexed EventWithStructWithNestedStruct correctly', async () => {
    // Emit the event
  ...
  it('should have indexed EventWithStructWithFixedStructArray correctly', async () => {
    // Emit the event
  ...
  it('should have indexed EventWithStructWithDynamicStructArray correctly', async () => {
    // Emit the event
  ...
  it('should have indexed EventWithStructWithArrays correctly', async () => {
    // Emit the event
